...
public class PersonaPrueba {
    ...
    public static void main(String[] args) {
        Persona persona1 = new Persona("Isabel", 40000.00, false);
        ...
        persona1.setNombre("Ana"); // a traves de "set" para modificar
 ...
 /*1:*/
        Persona persona2 = new Persona("Carlos", 30000.00, false);
