...
persona2 = ("Carlos","Giachero") #Desempaquetamos a través de una tupla
show(*persona2)
persona3 = {"lastName":"Mario", "name":"Kart"}
show(**persona3)
...
listarNombres('Nico','José','Bruno','Roma','Giovi')
