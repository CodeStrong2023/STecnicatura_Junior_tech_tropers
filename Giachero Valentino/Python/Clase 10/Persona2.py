...
if __name__ == ' main ':
    persona1 = Persona2("Juan", "Lopez", 41)
    print(persona1.nombre)  # Llamamos al método getter
    persona1.nombre = "Sergio Dennis"  # Llamamos el método setter
    ...
    persona2 = Persona2("Valentino", "Giachero", 21)
    persona3 = Persona2("Santos", "Randazzo", 65)
    persona4 = Persona2("Carlos", "Giachero", 58)

    # Objeto 1
    persona2.nombre = "Valentino Estrella"
    persona2.apellido = "Giachero"
    persona2.edad = 21
    ...
    # Objeto 2
    persona3.nombre = "Santos"
    persona3.apellido = "Randazzo"
    persona3.edad = 65
