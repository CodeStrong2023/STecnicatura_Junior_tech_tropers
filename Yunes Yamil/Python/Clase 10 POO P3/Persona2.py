...
if __name__ == ' main ':
    ...
    persona1.nombre = "Juan Francisco"  # Llamamos el método setter
    ...
    persona2 = Persona2("Yamil Jesus", "Yunes", 24)
    persona3 = Persona2("Franco", "Pagano", 74)
    persona4 = Persona2("Mauro", "Barroso", 47)
