...
//        }
        ...
        personas[0][0] = new Persona("Nelson");
        personas[0][1] = new Persona("Ezequiel");
        personas[0][2] = new Persona("Noslen");
        personas[1][0] = new Persona("Mariano");
        personas[1][1] = new Persona("Onairam");
        personas[1][2] = new Persona("Emanuel");
        imprimir(personas);
    }
